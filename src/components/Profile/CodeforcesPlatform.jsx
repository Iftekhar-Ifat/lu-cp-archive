...
const CodeforcesPlatform = ({ hasCodeforcesAccount }) => {
    ...
    const userCFinfo = useQuery({
        ...
        queryFn: () => getCFInfo(hasCodeforcesAccount),
        cacheTime: Infinity,
        staleTime: Infinity,
        enabled: !!hasCodeforcesAccount, // active when hasCodeforcesAccount has value
    });
    ...
    return (
        <Grid item xs={2} sm={4} md={4}>
            <div className={styles.card_wrapper}>
                ...
                {hasCodeforcesAccount ? (
                    <div>
                        <div className={styles.info}>
                            <div>
                                <TextField
                                    label={hasCodeforcesAccount}
